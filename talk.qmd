...
[$\tau = f(\mathcal{R}_{e}, \mathcal{S}, \theta)$]{.boxed .fragment .fade-out fragment-index=1}

[$\require{cancel} \tau = f(\xcancel{\mathcal{R}_{e}}, \mathcal{S}, \theta)$]{.boxed .fragment .fade-in fragment-index=1}
